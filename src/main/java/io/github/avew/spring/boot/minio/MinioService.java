...
package io.github.avew.spring.boot.minio;


import io.github.avew.spring.boot.minio.properties.MinioConfigurationProperties;
import io.minio.*;
 ...
 * All methods return an {@link io.github.avew.spring.boot.minio.MinioException} which wrap the Minio SDK exception.
...
public class MinioService {
     ...
     * @throws io.github.avew.spring.boot.minio.MinioException if an error occur while fetch object
     */
    public InputStream get(Path path) throws io.github.avew.spring.boot.minio.MinioException {
        try {
            ...
            throw new io.github.avew.spring.boot.minio.MinioException("Error while fetching files in Minio", e);
        }
    }
     ...
     * @throws io.github.avew.spring.boot.minio.MinioException if an error occur while fetching object metadatas
     */
    public StatObjectResponse getMetadata(Path path) throws io.github.avew.spring.boot.minio.MinioException {
        try {
     ...
     * @throws io.github.avew.spring.boot.minio.MinioException if an error occur while fetch object
     */
    public void getAndSave(Path source, String fileName) throws io.github.avew.spring.boot.minio.MinioException {
        try {
     ...
     * @throws io.github.avew.spring.boot.minio.MinioException if an error occur while uploading object
     */
    public void upload(Path source, InputStream file, Map<String, String> headers) throws
        io.github.avew.spring.boot.minio.MinioException {
        try {
     ...
     *
     * @param source Path with prefix to the object. Object name must be included.
     * @throws io.github.avew.spring.boot.minio.MinioException if an error occur while removing object
     */
    public void remove(Path source) throws io.github.avew.spring.boot.minio.MinioException {
        try {
